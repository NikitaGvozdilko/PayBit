...
public class UpdateMobileNumberProfileAsync extends AsyncTask<Void, Void, Boolean> {
...
//    public Context context;
    ...
    public UpdateMobileNumberProfile fActivity;




    public UpdateMobileNumberProfileAsync(UpdateMobileNumberProfile fActivity) {
...
//        progressDialog = ProgressDialog.show(fActivity, "", "", true, false);
        ...
        if(!sessionDCM.mobileNumber.equals(fActivity.mobileNumber)){
            sessionDCM.mobileNumber=fActivity.mobileNumber;
