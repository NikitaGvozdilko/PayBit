...
public class UpdateSecondaryAddressProfileAsync extends AsyncTask<Void, Void, Boolean> {
    ...
    public updateSecondaryAddressProfile fActivity;


    public UpdateSecondaryAddressProfileAsync(updateSecondaryAddressProfile fActivity) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
//        progressDialog = ProgressDialog.show(fActivity.context, "", "", true, false);
        ...
        if(sessionDCM.address2 == null)
        {
            sessionDCM.address2 = "";
        }
        if (!sessionDCM.address2.equals(fActivity.messageAddress)) {
            sessionDCM.address2 = fActivity.messageAddress;
            sessionDCM.buildingName2 = fActivity.buildingName2;
            sessionDCM.floorNumber2 = fActivity.floorNumber2;

            sessionDCM.latitude2 = fActivity.latitude2;
            sessionDCM.longitude2 = fActivity.longitude2;
        ...
        if (!sessionDCM.buildingName2.equals(fActivity.buildingName2)) {
            sessionDCM.buildingName2 = fActivity.buildingName2;
            sessionDAO.update(sessionDCM);
            requestUpdateStatusModel.user = sessionDCM;
        }
        if (!sessionDCM.floorNumber2.equals(fActivity.floorNumber2)) {
            sessionDCM.floorNumber2 = fActivity.floorNumber2;
            sessionDAO.update(sessionDCM);
            requestUpdateStatusModel.user = sessionDCM;
        } else {
