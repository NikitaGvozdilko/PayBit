...
public class UserExistsCheckSettingsEmailAsync extends AsyncTask<Void, Void, Boolean> {
    ...
    public UserExistsCheckSettingsEmailAsync(UpdateEmailProfile updateEmailProfile , String identifyField) {
    ...
    protected void onPostExecute(Boolean response) {
        ...
        if (response == false) {
            new AlertDialog.Builder(updateEmailProfile.context)
            ...
            if (getUserExitsCheckResponse != null) {
                 ...
                 if (getUserExitsCheckResponse.userExits) {
                    ...
                    {
                        updateEmailProfile.edtEmail.setError("This email address is already registered!");
                        updateEmailProfile.valid = false;
                        updateEmailProfile.edtEmail.requestFocus();
                    }
                     else
                    {
//                        updateEmailProfile.PhoneNumber.setError("This contact number is already registered!");
//                        updateEmailProfile.valid = false;
//                        updateEmailProfile.PhoneNumber.requestFocus();
                    }
                } else {
                     if(getUserExitsCheckRequest.identifyField.contains("@"))
                     {
                         updateEmailProfile.edtEmail.setError(null);
                         updateEmailProfile.valid = true;
                     }
                     else
                     {
//                         updateEmailProfile.PhoneNumber.setError(null);
//                         updateEmailProfile.valid = true;
                     }
                 }
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(updateEmailProfile.context)
                        .setTitle(FixLabels.alertDefaultTitle)
                        .setCancelable(false)
