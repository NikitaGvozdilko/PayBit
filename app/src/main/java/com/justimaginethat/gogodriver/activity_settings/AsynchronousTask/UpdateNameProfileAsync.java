...
public class UpdateNameProfileAsync extends AsyncTask<Void, Void, Boolean> {
...
//    public Context context;
    ...
    public updateNameProfile fActivity;




    public UpdateNameProfileAsync(updateNameProfile fActivity) {
...
//        progressDialog = ProgressDialog.show(fActivity, "", "", true, false);
        ...
        if(!sessionDCM.firstName.equals(fActivity.firstName)){
            sessionDCM.firstName=fActivity.firstName;
