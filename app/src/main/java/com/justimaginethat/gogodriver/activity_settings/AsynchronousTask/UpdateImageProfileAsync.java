...
public class UpdateImageProfileAsync extends AsyncTask<Void, Void, Boolean> {
...
//    public Context context;
    ...
    public activity_update_setting fActivity;




    public UpdateImageProfileAsync(activity_update_setting fActivity) {
...
//        progressDialog = ProgressDialog.show(fActivity.context, "", "", true, false);
        ...
        if(!sessionDCM.profilePicture.equals(fActivity.profilePicture)){
            sessionDCM.profilePicture=fActivity.profilePicture;
