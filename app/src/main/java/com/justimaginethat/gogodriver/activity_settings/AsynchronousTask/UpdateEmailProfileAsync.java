...
public class UpdateEmailProfileAsync extends AsyncTask<Void, Void, Boolean> {
    ...
    public UpdateEmailProfile fActivity;




    public UpdateEmailProfileAsync(UpdateEmailProfile fActivity) {
...
//        progressDialog = ProgressDialog.show(fActivity, "", "", true, false);
        ...
        if(!sessionDCM.emailAddress.equals(fActivity.emailAddress)){
            sessionDCM.emailAddress=fActivity.emailAddress;
