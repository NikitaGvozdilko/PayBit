...
public class RegistrationActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent intentLocationScreen = new Intent(RegistrationActivity.this, activity_login.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appLocationService = new PickUpLocation(RegistrationActivity.this);
...
//        TlblSign = (TextView) findViewById(R.id.lblSign);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentBack=new Intent(RegistrationActivity.this,activity_login.class);
        ...
        img_profileCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LionUtilities.hasConnection(RegistrationActivity.this)) {
                    Intent i = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
                    startActivityForResult(i, RESULT_IMG_LOAD_UPLOAD);
                } else {
                    LionUtilities.makeToast(RegistrationActivity.this,
...
//
        ...
        ledtAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(RegistrationActivity.this,AddressMapPickerActivity.class);
...
//
        Email.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if(hasFocus == false && android.util.Patterns.EMAIL_ADDRESS.matcher(Email.getText().toString()).matches())
                {
...
//            progressDialog = ProgressDialog.show(RegistrationActivity.this, "", "", true, false);
            ...
            progressDialog = CustomProgressBar.show(RegistrationActivity.this,"", true,false,null);
        }
                                        ...
                                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                if (requestModel.UserDCM.isCustomer == true) {
                                                    Intent intentLocationScreen = new Intent(RegistrationActivity.this, fragment_activity_landing_user.class);
                                                    intentLocationScreen.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                                                    startActivity(intentLocationScreen);
                                                    finish();
                                                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                                                } else if (requestModel.UserDCM.isDriver == true) {
                                                    Intent intentLocationScreen = new Intent(RegistrationActivity.this, fragment_activity_landing_driver.class);
                                                    intentLocationScreen.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                                                    startActivity(intentLocationScreen);
                                                    finish();
                                                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
