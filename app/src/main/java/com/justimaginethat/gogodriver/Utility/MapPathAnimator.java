...
public class MapPathAnimator {

    private static MapPathAnimator mapAnimator;
    ...
    public MapPathAnimator() {

    }

    public static MapPathAnimator getInstance() {
        if (mapAnimator == null) mapAnimator = new MapPathAnimator();
        return mapAnimator;
    }
