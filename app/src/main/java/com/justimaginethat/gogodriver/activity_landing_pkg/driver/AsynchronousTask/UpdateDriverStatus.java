...
import com.justimaginethat.gogodriver.APIModels.DriverWorkspace.APIUpdateDriverStatusRequestModel;
import com.justimaginethat.gogodriver.APIModels.DriverWorkspace.APIUpdateDriverStatusResponseModel;
...
public class UpdateDriverStatus extends AsyncTask<Void, Void, Boolean> {

    public Context context;
    public CustomProgressBar progressDialog;
    public APIUpdateDriverStatusRequestModel requestUpdateStatusModel=new APIUpdateDriverStatusRequestModel();
    public BaseAPIResponseModel<APIUpdateDriverStatusResponseModel> responseUpdateStatusDataModel = new BaseAPIResponseModel<APIUpdateDriverStatusResponseModel>();
    public APIUpdateDriverStatusResponseModel responseUpdateStatusModel = new APIUpdateDriverStatusResponseModel();
    ...
    @Override
        ...
        requestUpdateStatusModel = new APIUpdateDriverStatusRequestModel();
...
//        progressDialog = ProgressDialog.show(fActivity, "", "", true, false);
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            String str = helperSP.requestHTTPResponse(APILinks.APIUpdateDriverStatus, map, "POST", false);
            if (str.equals("")) {
                return false;
            } else {
                ...
                responseUpdateStatusModel = gson.fromJson(str2, APIUpdateDriverStatusResponseModel.class);
                return true;
            }
        }
        @Override
 ...
 AlertDialog alertDialog = alertDialogBuilder.create();                                 alertDialog.setCanceledOnTouchOutside(false);                                 alertDialog.setCancelable(false);                                 alertDialog.show();
                ...
                if (responseUpdateStatusModel != null) {
                    if (responseUpdateStatusModel.errorLogId == 0) {
                        ...
                        if (responseUpdateStatusModel.idDriver >0) {
