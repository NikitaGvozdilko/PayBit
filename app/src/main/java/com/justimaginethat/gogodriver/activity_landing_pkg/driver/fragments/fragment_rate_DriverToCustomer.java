...
import com.justimaginethat.gogodriver.activity_landing_pkg.driver.AsynchronousTask.DriverToCustomerRatingAsync;
...
public class fragment_rate_DriverToCustomer extends Fragment implements
        OnMapReadyCallback,
    ...
    public fragment_rate_DriverToCustomer FLRating;

    public UserDAO userDAO;
    public List<UserDCM> userDCMs = new ArrayList<>();

    public SessionDAO sessionDAO;
    public List<SessionDCM> sessionDCMs = new ArrayList<>();


    public fragment_rate_DriverToCustomer() {

    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_rate_driver_to_customer, container, false);
        ...
        try {
            userDCMs = userDAO.getAll();
        } catch (SQLException e) {
            e.printStackTrace();
        }
            userName.setText((userDCMs.get(0).firstName).toString());
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    new DriverToCustomerRatingAsync(FLRating).execute();
                                }
                            })
