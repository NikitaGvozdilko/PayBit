...
public class GoToCustomer_SetOrderStatusRepeateAsync extends AsyncTask<Void, Void, Boolean> {
    ...
    public GoToCustomer_SetOrderStatusRepeateAsync(fragment_goto_customer FLGotoPick) {
    ...
    @Override
        ...
        protected void onPostExecute(Boolean response) {
            ...
            if (response == false) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(FLGotoPick.getContext())
 ...
 AlertDialog alertDialog = alertDialogBuilder.create();                                 alertDialog.setCanceledOnTouchOutside(false);                                 alertDialog.setCancelable(false);                                 alertDialog.show();
        ...
        if(responseUpdateStatusModel.orderStatus != null) {
            ...
            if (
                    responseUpdateStatusModel.idDriver == responseUpdateStatusModel.idDriver
                            && responseUpdateStatusModel.idOrderMaster == responseUpdateStatusModel.idOrderMaster
                            && FLGotoPick.OrderStatus.equals(FixLabels.OrderStatus.DriverReachedYourLocation)) {
                FLGotoPick.canSetOrderStatus = false;
                FLGotoPick.fActivity.showLayout(FixLabels.OrderStatus.DriverReachedYourLocation);
            } else {
                FLGotoPick.canSetOrderStatus = true;
            }
        }
                            ...
                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(FLGotoPick.getContext())
                                    ...
                                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            i.putExtra("url", url);
                                            FLGotoPick.getContext().startActivity(i);
                                        }
                                    })
                                      .setIcon(android.R.drawable.ic_dialog_alert);
 AlertDialog alertDialog = alertDialogBuilder.create();                                 alertDialog.setCanceledOnTouchOutside(false);                                 alertDialog.setCancelable(false);                                 alertDialog.show();
