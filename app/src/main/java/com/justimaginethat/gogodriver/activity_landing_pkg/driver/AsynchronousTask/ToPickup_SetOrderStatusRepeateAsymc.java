...
public class ToPickup_SetOrderStatusRepeateAsymc extends AsyncTask<Void, Void, Boolean> {
    ...
    public ToPickup_SetOrderStatusRepeateAsymc(fragment_goto_pickup FLGotoPick) {
            ...
            if (responseUpdateStatusModel != null) {
                if (responseUpdateStatusModel.errorLogId == 0) {
                    ...
                    if (responseUpdateStatusModel.orderStatus != null) {
                        ...
                        } else if (responseUpdateStatusModel.orderStatus.equals(FixLabels.OrderStatus.OrderCanceled) || responseUpdateStatusModel.orderStatus == null) {

                            new AlertDialog.Builder(FLGotoPick.context)
                                    .setTitle(FixLabels.alertDefaultTitle)
                                    .setCancelable(false)
