...
public class ToCustomer_LineDrawOnMapDAsync extends AsyncTask<String, Integer, List<List<HashMap<String,String>>> > {


    public fragment_goto_customer fragmentPickupHandel;

    public ToCustomer_LineDrawOnMapDAsync(fragment_goto_customer fragmentPickupHandel) {
