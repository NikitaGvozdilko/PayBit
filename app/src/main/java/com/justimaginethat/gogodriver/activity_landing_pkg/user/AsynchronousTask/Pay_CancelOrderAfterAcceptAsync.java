...
public class Pay_CancelOrderAfterAcceptAsync extends AsyncTask<Void, Void, Boolean> {
    ...
    public fragment_driver_arrived_at_pickup fragmentDriverHandel;
    ...
    public Pay_CancelOrderAfterAcceptAsync(fragment_driver_arrived_at_pickup fragmentDriverHandel) {
